...
import { CATEG_EVENT_LABEL, CONFIRMED_EVENT_LABEL, CUSTOMER_EVENT_LABEL, DATE_EVENT_LABEL, NOT_CONFIRMED_EVENT_LABEL, PLACE_EVENT_LABEL } from 'src/assets/labels';
